...
class DatabaseHelper {
  ...
  Future<void> _createTables(Database db) async {
    ...
    await db.execute('''CREATE TABLE jarvis_chat_rooms(
      id TEXT PRIMARY KEY,
      name TEXT NOT NULL,
      messages TEXT NOT NULL DEFAULT '[]',
      createdAt TEXT
    ...
    await db.execute('''CREATE TABLE jarvis_doc_analysis(
      id INTEGER PRIMARY KEY AUTOINCREMENT,
      subjectId INTEGER NOT NULL,
      docId INTEGER NOT NULL,
      analysis TEXT NOT NULL,
    ...
    // ── NOVA tables ──────────────────────────────────────────────────────────
    await db.execute('''CREATE TABLE nova_subject_intel(
      subjectId   INTEGER PRIMARY KEY,
      subjectName TEXT NOT NULL,
      cardText    TEXT NOT NULL,
      documentCount INTEGER DEFAULT 0,
    ...
    await db.execute('''CREATE TABLE nova_study_plan(
      id         INTEGER PRIMARY KEY AUTOINCREMENT,
      subjectId  INTEGER,
      dayOfWeek  INTEGER NOT NULL,
      date       TEXT NOT NULL,
    ...
    await db.execute('''CREATE TABLE nova_daily_schedule(
      id         INTEGER PRIMARY KEY AUTOINCREMENT,
      dayOfWeek  INTEGER NOT NULL,
      slotHour   INTEGER NOT NULL,
      slotMinute INTEGER NOT NULL,
    ...
    await db.execute('''CREATE TABLE nova_watchdog_apps(
      package     TEXT PRIMARY KEY,
      displayName TEXT NOT NULL,
      limitMinutes INTEGER NOT NULL DEFAULT 30
    )''');
    await db.execute('''CREATE TABLE nova_weekly_briefing(
      weekNumber  INTEGER PRIMARY KEY,
      briefingText TEXT NOT NULL,
      createdAt   TEXT
    )''');
